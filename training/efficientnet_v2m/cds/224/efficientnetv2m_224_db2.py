...
IMG_SIZE = (224, 224) # Caso de teste para tamanho de imagem menor
BATCH_SIZE = 16
CHANNELS = 3
...
history_fine = model.fit(
    ...
    callbacks=[
        ...
        keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/saved_models/efficientnetv2m_db2_224_corn_classifier.keras', monitor='val_accuracy', save_best_only=True, mode='max')
    ]
)
