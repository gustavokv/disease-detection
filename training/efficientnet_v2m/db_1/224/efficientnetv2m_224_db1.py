...
history_fine = model.fit(
    ...
    callbacks=[
        ...
        keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/saved_models/efficientnetv2m_db1_224_corn_classifier.keras', monitor='val_accuracy', save_best_only=True, mode='max')
    ]
)
