...
history_fine = model.fit(
    ...
    callbacks=[
        ...
        keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/models/resnet101_corn_classifier.keras', monitor='val_accuracy', save_best_only=True, mode='max')
    ]
)
