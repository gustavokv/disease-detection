...
history_fine = model.fit(
    ...
    callbacks=[
        ...
        keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/saved_models/mobilenetv3_db2_corn_classifier.keras', monitor='val_accuracy', save_best_only=True, mode='max')
    ]
)
