...
IMG_SIZE = (224, 224) # Ideal para o ResNet50
BATCH_SIZE = 16
CHANNELS = 3
...
history_fine = model.fit(
    ...
    callbacks=[
        ...
        keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/models/resnet50_corn_disease_classifier.keras', monitor='val_accuracy', save_best_only=True, mode='max')
    ]
)
