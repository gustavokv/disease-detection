...
# Exibe plots no notebook (importante para o Colab)
%matplotlib inline

# (Opcional) Monta o Google Drive, se desejar usar arquivos de lá
from google.colab import drive
drive.mount('/content/drive')

# Caminho para os dados (ajuste conforme o local dos arquivos no Colab)
DATA_DIR = '/content/drive/MyDrive/data'  # Ex: '/content/drive/MyDrive/seus_dados'

# Desativa otimizações (opcional)
os.environ['TF_ENABLE_ONEDNN_OPTS'] = '0'
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'

IMG_SIZE = (480, 480) # Ideal para o EfficientNetV2M
BATCH_SIZE = 16
CHANNELS = 3
...
history_fine = model.fit(
    ...
    callbacks=[
        ...
        keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/models/efficientnetv2m_corn_classifier.keras', monitor='val_accuracy', save_best_only=True, mode='max')
    ]
)
...
plot_history(DummyHistory(combined_history), 'Treinamento Completo')