...
IMG_SIZE = (224, 224)  # Recomendado para ResNet101
BATCH_SIZE = 16
CHANNELS = 3
...
def evaluate_model(model, val_ds, class_names):
    ...
    plt.title("Matriz de Confusão - ResNet101")
    plt.tight_layout()
    plt.show()
...
history_fine = model.fit(
    ...
    callbacks=[
        ...
        keras.callbacks.ModelCheckpoint('/content/drive/MyDrive/models/resnet101_db1_corn_classifier.keras', monitor='val_accuracy', save_best_only=True, mode='max')
    ]
)
...
plot_history(DummyHistory(combined_history), 'Treinamento Completo - ResNet101')
